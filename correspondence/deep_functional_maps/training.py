...
class ensembleTrainer:
    ...
    def __init__(self, files, lr = 1e-3, bs = 1, chkpt_name = None):
        self.func = ops.residualNet(7, num_sigs, training = True) #ops.correspondenceMatrix(num_sigs, training = True)
...
if __name__ == "__main__":
    ...
    input = ['./data/ape_teeth.tfrecords']
    trainer = ensembleTrainer(files = input, lr = 1e-4, bs = 2, chkpt_name = "ape_teeth")
    trainer.train(EPOCHS = 1000, chkpt_name = 'ape_teeth')
